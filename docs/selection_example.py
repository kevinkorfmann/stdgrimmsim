...
def adaptive_introgression(seed):
    ...
    extended_events = [
        ...
        stdgrimmsim.ConditionOnAlleleFrequency(
            ...
            start_time=stdgrimmsim.GenerationAfter(T_mut),
        ...
        stdgrimmsim.ConditionOnAlleleFrequency(
            start_time=stdgrimmsim.GenerationAfter(T_Den_split),
            end_time=T_mig,
            single_site_id=locus_id,
            population="Den1",
            op=">",
        ...
        stdgrimmsim.ConditionOnAlleleFrequency(
            start_time=stdgrimmsim.GenerationAfter(T_mig),
            end_time=0,
            single_site_id=locus_id,
            population="Papuan",
            op=">",
...
if __name__ == "__main__":
    ...
    stdgrimmsim.cli.setup_logging(args)
