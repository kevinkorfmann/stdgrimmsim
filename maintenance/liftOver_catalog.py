...
def main():
    ...
    parser.add_argument("--species", dest="species", help="stdgrimmsim species name")
    parser.add_argument("--map", dest="map", help="stdgrimmsim map name")
    parser.add_argument(
    ...
    # Grab metadata from stdgrimmsim
    species = stdgrimmsim.get_species(args.species)
