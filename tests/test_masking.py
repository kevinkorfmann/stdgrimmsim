...
class TestMasking:
    ...
    def test_load_intervals(self, tmp_path):
        ...
        intervals_chr1 = stdgrimmsim.utils.read_bed(bedfile, "chr1")
        intervals_chr22 = stdgrimmsim.utils.read_bed(bedfile, "chr22")
    ...
    def test_read_bed(self, tmp_path):
        ...
        intervals_utils = stdgrimmsim.utils.read_bed(bedfile, "chr1")
    ...
    def test_mask_tree_sequence(self):
        ...
        exclude = False
        ts_mask = stdgrimmsim.utils.mask_tree_sequence(ts, intervals, exclude)
...
class TestSimulate:
    ...
    def test_simulate_with_mask(self):
        ...
        for engine_name in engines:
            engine = stdgrimmsim.get_engine(engine_name)
