...
class CacheReadingTest:
    ...
    @classmethod
    def setup_class(cls):
        cls.saved_cache_dir = stdgrimmsim.get_cache_dir()
        stdgrimmsim.set_cache_dir(cls.cache_dir)

    @classmethod
    def teardown_class(cls):
        stdgrimmsim.set_cache_dir(cls.saved_cache_dir)
...
class CacheWritingTest:
    ...
    def setup_class(cls):
        ...
        stdgrimmsim.set_cache_dir(cls.tmp_cache_dir.name)
