...
class TestAllDFEs:
    ...
    def test_non_empty(self):
        ...
        assert isinstance(list(stdgrimmsim.all_dfes()), list)

    @pytest.mark.parametrize("d", list(stdgrimmsim.all_dfes()))
...
class TestCreateDFE:
    ...
    def test_dfe_errors(self):
        m1 = stdgrimmsim.MutationType()
        m2 = stdgrimmsim.MutationType()
