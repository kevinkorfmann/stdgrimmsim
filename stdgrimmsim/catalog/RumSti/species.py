...
_species = stdgrimmsim.Species(
    id="RumSti",
    ensembl_id="rumpelstilzchen_thuringiensis",
    name="Rumpelstilzchen thuringiensis",
    common_name="Rumpelstiltskin (Grimm KHM 55)",
    separate_sexes=True,
    genome=_genome,
    generation_time=22,
    population_size=48_000,
