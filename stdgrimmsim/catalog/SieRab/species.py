...
_recombination_rate = {c: 1.4e-8 for c in genome_data.data["chromosomes"]}
_recombination_rate["glass_mitogenome"] = 0
_mutation_rate = {c: 6e-9 for c in genome_data.data["chromosomes"]}
_mutation_rate["glass_mitogenome"] = 7.5e-8
_species_ploidy = 2
_ploidy = {c: _species_ploidy for c in genome_data.data["chromosomes"]}
_ploidy["glass_mitogenome"] = 1
...
_species = stdgrimmsim.Species(
    id="SieRab",
    ensembl_id="corvus_septem_ravens",
    name="Corvus septem ravens",
    common_name="Seven Ravens (Grimm KHM 25 — Die sieben Raben)",
    separate_sexes=True,
    genome=_genome,
    generation_time=18,
    population_size=65_000,
