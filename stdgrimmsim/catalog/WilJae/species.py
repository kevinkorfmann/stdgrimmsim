...
_recombination_rate = {c: 2.3e-8 for c in genome_data.data["chromosomes"]}
_recombination_rate["spectral_mitogenome"] = 0
_mutation_rate = {c: 2.4e-8 for c in genome_data.data["chromosomes"]}
_mutation_rate["spectral_mitogenome"] = 6.5e-8
_species_ploidy = 2
_ploidy = {c: _species_ploidy for c in genome_data.data["chromosomes"]}
_ploidy["spectral_mitogenome"] = 1
...
_species = stdgrimmsim.Species(
    id="WilJae",
    ensembl_id="wildjaeger_germanicus",
    name="Wildjaeger germanicus",
    common_name="Wilde Jagd (Wild Hunt)",
    separate_sexes=True,
    genome=_genome,
    generation_time=60,
