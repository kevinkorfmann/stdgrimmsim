...
_citation = stdgrimmsim.Citation(
    author="Black Forest folklore / Grimm",
    year=1812,
...
_recombination_rate = {c: 3.5e-8 for c in genome_data.data["chromosomes"]}
_recombination_rate["forest_mitogenome"] = 0
_mutation_rate = {c: 1.8e-8 for c in genome_data.data["chromosomes"]}
_mutation_rate["forest_mitogenome"] = 7e-8
_species_ploidy = 2
...
_species = stdgrimmsim.Species(
    id="SchWar",
    ensembl_id="silvani_schwarzwaldensis",
    name="Silvani schwarzwaldensis",
    common_name="Black Forest spirit",
    separate_sexes=True,
    genome=_genome,
    generation_time=20,
    population_size=120_000,
