...
_species = stdgrimmsim.Species(
    id="BerAlp",
    ensembl_id="berchta_alpina",
    name="Berchta alpina",
    common_name="Berchta / Perchta (Bavarian–Alpine winter figure)",
    separate_sexes=True,
    genome=_genome,
    generation_time=35,
    population_size=42_000,
