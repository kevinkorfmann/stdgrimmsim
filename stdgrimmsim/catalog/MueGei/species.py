...
_citation = stdgrimmsim.Citation(
    author="German folk ghost stories / Grimm",
    year=1720,
...
_mutation_rate["spectral_mitogenome"] = 9.0e-8
_species_ploidy = 2
...
_species = stdgrimmsim.Species(
    id="MueGei",
    ensembl_id="muellerin_geisterhaft",
    name="Muellerin geisterhaft",
    common_name="Mill Ghost (M\u00fchlengeist)",
    separate_sexes=True,
    genome=_genome,
    generation_time=20,
