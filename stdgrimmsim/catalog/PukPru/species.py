...
_citation = stdgrimmsim.Citation(
    author="Prussian / Baltic folklore",
    year=1700,
...
_species = stdgrimmsim.Species(
    id="PukPru",
    ensembl_id="puk_prussicus",
    name="Puk prussicus",
    common_name="Puk (Prussian house spirit)",
    separate_sexes=True,
    genome=_genome,
    generation_time=18,
    population_size=180_000,
