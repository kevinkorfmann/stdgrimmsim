...
_citation = stdgrimmsim.Citation(
    author="German river folklore / Grimm",
    year=1812,
...
_recombination_rate = {c: 2.9e-8 for c in genome_data.data["chromosomes"]}
_recombination_rate["aquatic_mitogenome"] = 0
_mutation_rate = {c: 2.7e-8 for c in genome_data.data["chromosomes"]}
_mutation_rate["aquatic_mitogenome"] = 8e-8
_species_ploidy = 2
_ploidy = {c: _species_ploidy for c in genome_data.data["chromosomes"]}
_ploidy["aquatic_mitogenome"] = 1
...
_species = stdgrimmsim.Species(
    id="FeeFlu",
    ensembl_id="flussfee_aquaticus",
    name="Flussfee aquaticus",
    common_name="Flussfee (River Fairy)",
    separate_sexes=True,
    genome=_genome,
    generation_time=30,
    population_size=55_000,
