...
class DemographicModel:
    ...
    :ivar ~.id: The unique identifier for this model. DemographicModel IDs should be
        short and memorable, and conform to the stdgrimmsim
    ...
    def get_samples(self, *args):
        ...
        warnings.warn(
            stdgrimmsim.DeprecatedFeatureWarning(
                ...
                "`stdgrimmsim SpeciesName population_name:num_samples` (CLI). Note "
...
class PiecewiseConstantSize(DemographicModel):
    ...
    .. code-block:: python
        ...
        model1 = stdgrimmsim.PiecewiseConstantSize(N0, (t1, N1))  # One change
        model2 = stdgrimmsim.PiecewiseConstantSize(N0, (t1, N1), (t2, N2))  # Two changes
    """
...
class IsolationWithMigration(DemographicModel):
    ...
    .. code-block:: python
        ...
        model1 = stdgrimmsim.IsolationWithMigration(NA, N1, N2, T, M12, M21)
