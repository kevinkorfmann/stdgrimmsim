...
def is_valid_demographic_model_id(model_id):
    ...
    Year may be 2–3 digits for catalog compatibility (e.g. 27 or 730).
    """
    regex = re.compile(r"[A-Z][A-Za-z0-9]*_[1-9]\d*[A-Z]\d{2,3}")
...
def append_common_synonyms(genome):
    ...
    The input is a stdgrimmsim.Genome object, and synonyms are appended in place.
    """
